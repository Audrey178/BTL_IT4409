import { Info, Phone, UserPlus, Video } from "lucide-react";
    ...
    <header className="sticky top-0 z-20 flex h-20 shrink-0 items-center justify-between border-b border-outline-variant/30 bg-surface/95 px-8 backdrop-blur-xl">
      ...
      <div className="flex items-center gap-2 shrink-0">
        ...
        <Button
          disabled={!conversation}
          onClick={() => onStartCall("video")}
          className="bg-primary text-white px-6 py-2.5 rounded-full flex items-center gap-2 font-body-bold shadow-lg shadow-primary/20 h-auto"
        >
